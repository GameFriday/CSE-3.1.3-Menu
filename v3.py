...
if Beverage.lower() == "yes":
  ...
  print("You sure you don't want a beverage?")
elif Beverage.lower() == "":
  print("you didn't choose anything")
else: 
  print("Please make sure it is spelled correctly and has no spaces.")
...
if Fries.lower() == "no":
  ...
  FriesSize = "no"
print("You ordered", sandwich_type, "sandwich,", Beverage, "drink,", FriesSize, "fries")
...
if Fries.lower() == "no":
  ...
  if FriesSize.lower() == "small":
      ...
      friesPrice = 2.00
total =(sandwichPrice + drinkPrice + friesPrice)
